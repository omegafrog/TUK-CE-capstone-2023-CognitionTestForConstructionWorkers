...
var ctx = document.getElementById("Brielle_Williamsong5c");
    ...
    tooltips: {
      ...
      callbacks: {
        label: function(tooltipItem, chart) {
          ...
          return datasetLabel + " : " + number_format(tooltipItem.yLabel) + '자리';
        }
      }
    }
  }
